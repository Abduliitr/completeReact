...
import { Breadcrumb, BreadcrumbItem, Col, Row, Button, Form, FormGroup, Label, Input, FormFeedback } from 'reactstrap';
...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email){
        ...
        // using a regex expression here...
        const reg = /^\d+$/;
        if(this.state.touched.telnum && !reg.test(telnum))
            errors.telnum = 'Tel. Number contain only numbers!'
